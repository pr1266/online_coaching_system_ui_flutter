...
class Services{
  ...
  Future<int> AcceptContract(String ID, String Athlete, String Coach, bool Status, Map<String, String> Header) async{
    var body = {
      'athlete': Athlete,
      'coach': Coach,
      'status': true.toString()
    };
    var response = await put('http://10.0.2.2:8000/contract/${ID}/edit/', body: body, headers: Header);
